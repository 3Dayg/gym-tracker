...
- **Where do I change my weight?** Tap the person icon. See [Settings](profile.md).
...
- **Can I change kg to lb?** Yes — Units on Settings. Numbers convert automatically (100 kg becomes about 220.5 lb). Switching back restores the original values.
- **Will deleting an exercise erase my history?** No. Past workouts keep the exercise name even if the exercise is gone.
- **How do I back up?** Settings → **Export JSON backup** or **Export workouts CSV**. Nothing is uploaded; you choose where to save the file. **Delete All Data** wipes this iPhone and cannot be undone.
