...
| Order | Exercise | Time | Speed | Incline |
|---|---|---|---|---|
| 1 | Treadmill Walk | 5 min | easy (~4.5 km/h) | 1% warm-up |
| 2 | Incline Treadmill Walk | 3 × 10 min | talking pace (~5 km/h) | **12%** |
| 3 | Treadmill Walk | 5 min | easy (~4 km/h) | 1% cool-down |
...
**4–5 sessions a week.** Incline walking works for fat loss because it is easy to repeat, not because a single session is extreme.

Log body weight on the **Progress** tab once a week, at the same time of day.
...
Change time, speed, or incline on the Plans tab. If you delete the plan, the app will not recreate it automatically.
