    ...
    var body: some View {
        List {
            ...
            Section("What stays on this iPhone") {
                Text("Workouts, plans, custom exercises, units, rest-timer preference, and optional height and body weight. Deleting the app deletes this data.")
            }
            ...
            Section("Your choices") {
                Text("Height and body weight are optional. You can skip them on first launch and add or remove them later in Profile. You can turn off notifications in iOS Settings.")
            }
        }
